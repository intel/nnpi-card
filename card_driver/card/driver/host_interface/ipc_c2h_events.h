...
#define SPH_IPC_GET_CR_FIFO_REPLY        (EVENT_NON_ERR_DRV_START + 29)
#define SPH_IPC_P2P_PEERS_CONNECTED      (EVENT_NON_ERR_DRV_START + 30)
#define SPH_IPC_P2P_PEER_DEV_UPDATED     (EVENT_NON_ERR_DRV_START + 31)
...
#define SPH_IPC_EXECUTE_COPY_FAILED        (EVENT_ERR_DRV_START + 27)
#define SPH_IPC_SCHEDULE_INFREQ_FAILED     (EVENT_ERR_DRV_START + 28)
#define SPH_IPC_EXECUTE_CPYLST_FAILED      (EVENT_ERR_DRV_START + 29)
...
#define SPH_IPC_CONTEXT_EXEC_ERROR            (EVENT_CONTEXT_FATAL_DRV_START + 0)
#define SPH_IPC_CTX_DRAM_ECC_UNCORRECTABLE    (EVENT_CONTEXT_FATAL_DRV_START + 1)

/* card critical error event codes */
#define SPH_IPC_ERROR_OS_CRASHED          (EVENT_CARD_FATAL_START + 0)
#define SPH_IPC_ERROR_DRAM_ECC_UNCORRECTABLE_FATAL  (EVENT_CARD_FATAL_START + 1)
#define SPH_IPC_ERROR_FATAL_ICE_ERROR     (EVENT_CARD_FATAL_START + 2)

/* card critical and driver fatal*/
#define SPH_IPC_ERROR_PCI_ERROR           (EVENT_CARD_FATAL_DRV_START + 0)
#define SPH_IPC_ERROR_MCE_UNCORRECTABLE_FATAL  (EVENT_CARD_FATAL_DRV_START + 1)
#define SPH_IPC_ERROR_CARD_RESET          (EVENT_CARD_FATAL_DRV_START + 2)
#define SPH_IPC_ERROR_CHANNEL_KILLED      (EVENT_CARD_FATAL_DRV_START + 3)
...
enum event_val {
	...
	SPH_IPC_ICEDRV_INFER_EXEC_ERROR = 27,
	SPH_IPC_ICEDRV_INFER_EXEC_ERROR_NEED_RESET = 28,
	SPH_IPC_ICEDRV_INFER_EXEC_ERROR_NEED_CARD_RESET = 29,
	SPH_IPC_NO_EXEC_ERRORS          = 30,
	SPH_IPC_IO_ERROR                = 31,
 ...
 * SPH_IPC_ERROR_FATAL_ICE_ERROR    Failed contextID No-Valid    Not-Valid                     NoT-Valid
 * SPH_IPC_CONTEXT_EXEC_ERROR       Failed cmd-type  Valid       cmd obj protocolID            devnetID
