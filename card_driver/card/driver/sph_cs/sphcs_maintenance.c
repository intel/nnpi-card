...
static int debug_fpga_power_correction_show(struct seq_file *m, void *v)
{
	...
	seq_printf(m, "%hu\n", i2c_smbus_read_word_data(s_fpga_client, FPGA_SA_PWR_ORIG_SLOPE_REG));
	seq_printf(m, "%hu\n", i2c_smbus_read_word_data(s_fpga_client, FPGA_SA_PWR_ORIG_OFFSET_REG));
	seq_printf(m, "%hu\n", i2c_smbus_read_word_data(s_fpga_client, FPGA_VCCIN_PWR_ORIG_SLOPE_REG));
	seq_printf(m, "%hu\n", i2c_smbus_read_word_data(s_fpga_client, FPGA_VCCIN_PWR_ORIG_OFFSET_REG));
	seq_printf(m, "%hu\n", i2c_smbus_read_word_data(s_fpga_client, FPGA_SA_PWR_SLOPE_REG));
	seq_printf(m, "%hu\n", i2c_smbus_read_word_data(s_fpga_client, FPGA_VCCIN_PWR_SLOPE_REG));
	seq_printf(m, "%hu\n", i2c_smbus_read_word_data(s_fpga_client, FPGA_OVERALL_PWR_OFFSET_REG));
