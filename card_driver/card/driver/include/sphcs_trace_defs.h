...
enum sph_trace_inf_enum {
	...
	SPH_TRACE_INF_C2H_COPY_HANDLE	= 3, //SPH_TRACE_STR_Cs2H_COPY_HANDLE
	SPH_TRACE_INF_NETWORK		= 4, //SPH_TRACE_STR_NETWORK
	SPH_TRACE_INF_INF_REQ		= 5, //SPH_TRACE_STR_INF_REQ
	SPH_TRACE_INF_INF_SYNC		= 6, //SPH_TRACE_STR_INF_SYNC
	SPH_TRACE_INF_COMMAND_LIST	= 7, //SPH_TRACE_STR_COMMAND_LIST
	SPH_TRACE_INF_ADD_TO_COPY_LIST	= 8, //SPH_TRACE_STR_ADD_TO_COPY_LIST
	SPH_TRACE_INF_COPY              = 9, //SPH_TRACE_STR_COPY
	SPH_TRACE_INF_NUM		= 10 //SPH_TRACE_STR_UNDEFINED
};
