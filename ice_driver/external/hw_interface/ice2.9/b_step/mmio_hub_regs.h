...
#define CVE_MMIO_HUB_CVE_WATCHDOG_INIT_MMOFFSET 0x1EC
#define CVE_MMIO_HUB_CVE_SECONDARY_WATCHDOG_INIT_MMOFFSET 0x1F0
#define CVE_MMIO_HUB_CVE_CNC_WATCHDOG_INIT_MMOFFSET 0x1F4
#define CVE_MMIO_HUB_CVE_ID_MMOFFSET 0x1F8
#define CVE_MMIO_HUB_HOST2TLC_INTERRUPT_MMOFFSET 0x1FC
#define CVE_MMIO_HUB_HOST2ASIP_INTERRUPT_MMOFFSET 0x200
#define CVE_MMIO_HUB_HOST2IVP_INTERRUPT_MMOFFSET 0x204
#define CVE_MMIO_HUB_MMIO_NOTIFICATION_MMOFFSET 0x208
...
#define CVE_MMIO_HUB_CVE_DPCG_CONTROL_REG_MMOFFSET 0x230
#define CVE_MMIO_HUB_CVE_PG_CONTROL_MMOFFSET 0x234
#define CVE_MMIO_HUB_CVE_PG_DELAY_MMOFFSET 0x238
#define CVE_MMIO_HUB_CVE_PG_DFT_STAT_MMOFFSET 0x23C
#define CVE_MMIO_HUB_PDEBUGPC_ENABLE_REG_MMOFFSET 0x240
#define CVE_MMIO_HUB_PDEBUGPC_TLC_REG_MMOFFSET 0x244
#define CVE_MMIO_HUB_PDEBUGPC_ASIP_REG_MMOFFSET 0x248
...
/* */
/* SLMC, GECOE, GECOE2, DEEPSRAM, DSP, CVE_NUMBER_OF_GATED_CLKS}*/
...
/*   When this is 'true' dsp cg */
/* will send the special debug*/
/* messages each time execution*/
/* clock gate enabe/disable*/
uint32_t  RSVD_0               :   3;
/*  Nebulon auto filled RSVD [7:5] */
...
#define MMIO_HUB_MEM_DTF_CONTROL_BITFIELD_COUNT 0x06
...
#define MMIO_HUB_MEM_DTF_CONTROL_DTF_VTUNE2_MODE_LSB 0x0004
#define MMIO_HUB_MEM_DTF_CONTROL_DTF_VTUNE2_MODE_MSB 0x0004
#define MMIO_HUB_MEM_DTF_CONTROL_DTF_VTUNE2_MODE_RANGE 0x0001
#define MMIO_HUB_MEM_DTF_CONTROL_DTF_VTUNE2_MODE_MASK 0x00000010
#define MMIO_HUB_MEM_DTF_CONTROL_DTF_VTUNE2_MODE_RESET_VALUE 0x00000000
...
#endif
#define MMIO_HUB_MEM_CVE_WATCHDOG_INIT_OFFSET 0xec
...
#endif
#define MMIO_HUB_MEM_CVE_SECONDARY_WATCHDOG_INIT_OFFSET 0xf0
...
#endif
#define MMIO_HUB_MEM_CVE_CNC_WATCHDOG_INIT_OFFSET 0xf4
...
#endif
#define MMIO_HUB_MEM_CVE_ID_OFFSET 0xf8
...
#endif
#define MMIO_HUB_MEM_HOST2TLC_INTERRUPT_OFFSET 0xfc
...
#endif
#define MMIO_HUB_MEM_HOST2ASIP_INTERRUPT_OFFSET 0x00
...
#endif
#define MMIO_HUB_MEM_HOST2IVP_INTERRUPT_OFFSET 0x04
...
#endif
#define MMIO_HUB_MEM_MMIO_NOTIFICATION_OFFSET 0x08
...
/*  UNMAPPED_ERR_ID desc:  Stores the unmapped tid that caused the */
/* error */
...
/*  ------------------------------------------------------------------ */
/* */
#ifndef MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_FLAG
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_FLAG

/*  CVE_DPCG_CONTROL_REG desc:  DSP partition CLOCK GATING control */
/* Reset Domain : CVE Reset Function */
/* Domain : CVE Clock Gating*/
union MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_t {
	struct {
uint32_t  DPCG_CTRL_SW_DISABLE :   1;
/*   0: DPCG is enabled 1: DPCG is */
/* disabled*/
uint32_t  DPCG_CTRL_MSB_COUNTER_BITS :   2;
/*   two MSBits of 5 bits counters */
/* LSB are 3'b111 and control the*/
/* extra time given before CG*/
uint32_t  RSVD_0               :  29;
...
#endif
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_OFFSET 0x30
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_SCOPE 0x01
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_SIZE 32
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_BITFIELD_COUNT 0x02
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_RESET 0x00000001
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_SW_DISABLE_LSB 0x0000
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_SW_DISABLE_MSB 0x0000
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_SW_DISABLE_RANGE 0x0001
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_SW_DISABLE_MASK 0x00000001
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_SW_DISABLE_RESET_VALUE 0x00000001
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_MSB_COUNTER_BITS_LSB 0x0001
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_MSB_COUNTER_BITS_MSB 0x0002
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_MSB_COUNTER_BITS_RANGE 0x0002
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_MSB_COUNTER_BITS_MASK 0x00000006
#define MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_DPCG_CTRL_MSB_COUNTER_BITS_RESET_VALUE 0x00000000

/*  ------------------------------------------------------------------ */
/* */
#ifndef MMIO_HUB_MEM_CVE_PG_CONTROL_FLAG
#define MMIO_HUB_MEM_CVE_PG_CONTROL_FLAG

/*  CVE_PG_CONTROL desc:  Power Domain : power gate to the TNN control */
/* Reset Domain : CVE Reset */
/* Function Domain : CVE Clock Gating*/
union MMIO_HUB_MEM_CVE_PG_CONTROL_t {
	struct {
uint32_t  PG_CTRL              :   1;
/*   0: TNN Power is OFF 1: TNN */
/* Power is ON*/
uint32_t  RSVD_0               :  31;
/*  Nebulon auto filled RSVD [31:1] */
	}                                field;
...
#endif
#define MMIO_HUB_MEM_CVE_PG_CONTROL_OFFSET 0x34
#define MMIO_HUB_MEM_CVE_PG_CONTROL_SCOPE 0x01
#define MMIO_HUB_MEM_CVE_PG_CONTROL_SIZE 32
#define MMIO_HUB_MEM_CVE_PG_CONTROL_BITFIELD_COUNT 0x01
#define MMIO_HUB_MEM_CVE_PG_CONTROL_RESET 0x00000000
#define MMIO_HUB_MEM_CVE_PG_CONTROL_PG_CTRL_LSB 0x0000
#define MMIO_HUB_MEM_CVE_PG_CONTROL_PG_CTRL_MSB 0x0000
#define MMIO_HUB_MEM_CVE_PG_CONTROL_PG_CTRL_RANGE 0x0001
#define MMIO_HUB_MEM_CVE_PG_CONTROL_PG_CTRL_MASK 0x00000001
#define MMIO_HUB_MEM_CVE_PG_CONTROL_PG_CTRL_RESET_VALUE 0x00000000

/*  ------------------------------------------------------------------ */
/* */
#ifndef MMIO_HUB_MEM_CVE_PG_DELAY_FLAG
#define MMIO_HUB_MEM_CVE_PG_DELAY_FLAG

/*  CVE_PG_DELAY desc:  Power Domain : power gate delays Reset Domain */
/* : CVE Reset Function */
/* Domain : CVE Clock Gating*/
union MMIO_HUB_MEM_CVE_PG_DELAY_t {
	struct {
uint32_t  PG_RampDelay         :  12;    /* */
uint32_t  RSVD_0               :   3;
/*  Nebulon auto filled RSVD [14:12] */
uint32_t  PG_PowerGdDelay      :   8;    /* */
uint32_t  RSVD_1               :   9;
...
#endif
#define MMIO_HUB_MEM_CVE_PG_DELAY_OFFSET 0x38
#define MMIO_HUB_MEM_CVE_PG_DELAY_SCOPE 0x01
#define MMIO_HUB_MEM_CVE_PG_DELAY_SIZE 32
#define MMIO_HUB_MEM_CVE_PG_DELAY_BITFIELD_COUNT 0x02
#define MMIO_HUB_MEM_CVE_PG_DELAY_RESET 0x003c012c
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_RAMPDELAY_LSB 0x0000
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_RAMPDELAY_MSB 0x000b
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_RAMPDELAY_RANGE 0x000c
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_RAMPDELAY_MASK 0x00000fff
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_RAMPDELAY_RESET_VALUE 0x0000012c
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_POWERGDDELAY_LSB 0x000f
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_POWERGDDELAY_MSB 0x0016
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_POWERGDDELAY_RANGE 0x0008
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_POWERGDDELAY_MASK 0x007f8000
#define MMIO_HUB_MEM_CVE_PG_DELAY_PG_POWERGDDELAY_RESET_VALUE 0x00000078

/*  ------------------------------------------------------------------ */
/* */
#ifndef MMIO_HUB_MEM_CVE_PG_DFT_STAT_FLAG
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_FLAG

/*  CVE_PG_DFT_STAT desc:  Power Domain : power gate dft status Reset */
/* Domain : CVE Reset */
/* Function Domain : CVE Clock Gating*/
union MMIO_HUB_MEM_CVE_PG_DFT_STAT_t {
	struct {
uint32_t  PG_DFT_CurrentState  :   3;    /* */
uint32_t  RSVD_0               :   1;
/*  Nebulon auto filled RSVD [3:3] */
uint32_t  PG_DFT_PG_in_Trans   :   1;    /* */
uint32_t  RSVD_1               :  27;
...
#endif
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_OFFSET 0x3c
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_SCOPE 0x01
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_SIZE 32
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_BITFIELD_COUNT 0x02
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_RESET 0x00000000
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_CURRENTSTATE_LSB 0x0000
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_CURRENTSTATE_MSB 0x0002
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_CURRENTSTATE_RANGE 0x0003
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_CURRENTSTATE_MASK 0x00000007
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_CURRENTSTATE_RESET_VALUE 0x00000000
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_PG_IN_TRANS_LSB 0x0004
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_PG_IN_TRANS_MSB 0x0004
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_PG_IN_TRANS_RANGE 0x0001
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_PG_IN_TRANS_MASK 0x00000010
#define MMIO_HUB_MEM_CVE_PG_DFT_STAT_PG_DFT_PG_IN_TRANS_RESET_VALUE 0x00000000

/*  ------------------------------------------------------------------ */
/* */
#ifndef MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_FLAG
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_FLAG

/*  PDEBUGPC_ENABLE_REG desc:  Debug enable register : CVE Gated Reset */
/* Domain : CVE Reset Function */
/* Domain : CVE Functional 32 bit RW Register*/
union MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_t {
	struct {
uint32_t  tlcdebugen           :   1;    /*  32 bit RW field*/
uint32_t  asipdebugen          :   1;    /*  32 bit RW field*/
uint32_t  RSVD_0               :  30;
/*  Nebulon auto filled RSVD [31:2] */
	}                                field;
uint32_t                         val;
...
#endif
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_OFFSET 0x40
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_SCOPE 0x01
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_SIZE 32
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_BITFIELD_COUNT 0x02
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_RESET 0x00000000
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_TLCDEBUGEN_LSB 0x0000
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_TLCDEBUGEN_MSB 0x0000
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_TLCDEBUGEN_RANGE 0x0001
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_TLCDEBUGEN_MASK 0x00000001
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_TLCDEBUGEN_RESET_VALUE 0x00000000
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_ASIPDEBUGEN_LSB 0x0001
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_ASIPDEBUGEN_MSB 0x0001
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_ASIPDEBUGEN_RANGE 0x0001
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_ASIPDEBUGEN_MASK 0x00000002
#define MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_ASIPDEBUGEN_RESET_VALUE 0x00000000

/*  ------------------------------------------------------------------ */
/* */
#ifndef MMIO_HUB_MEM_PDEBUGPC_TLC_REG_FLAG
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_FLAG

/*  PDEBUGPC_TLC_REG desc:  Debug register : CVE Gated Reset Domain : */
/* CVE Reset Function Domain : */
/* CVE Functional 32 bit RW Register*/
union MMIO_HUB_MEM_PDEBUGPC_TLC_REG_t {
	struct {
uint32_t  tlcdebugpc           :  32;    /*  32 bit RW field*/
	}                                field;
uint32_t                         val;
};
#endif
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_OFFSET 0x44
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_SCOPE 0x01
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_SIZE 32
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_BITFIELD_COUNT 0x01
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_RESET 0x00000000
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_TLCDEBUGPC_LSB 0x0000
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_TLCDEBUGPC_MSB 0x001f
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_TLCDEBUGPC_RANGE 0x0020
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_TLCDEBUGPC_MASK 0xffffffff
#define MMIO_HUB_MEM_PDEBUGPC_TLC_REG_TLCDEBUGPC_RESET_VALUE 0x00000000

/*  ------------------------------------------------------------------ */
/* */
#ifndef MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_FLAG
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_FLAG

/*  PDEBUGPC_ASIP_REG desc:  Debug register : CVE Gated Reset Domain : */
/* CVE Reset Function Domain : */
/* CVE Functional 32 bit RW Register*/
union MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_t {
	struct {
uint32_t  asipdebugpc          :  32;    /*  32 bit RW field*/
	}                                field;
uint32_t                         val;
};
#endif
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_OFFSET 0x48
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_SCOPE 0x01
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_SIZE 32
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_BITFIELD_COUNT 0x01
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_RESET 0x00000000
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_ASIPDEBUGPC_LSB 0x0000
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_ASIPDEBUGPC_MSB 0x001f
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_ASIPDEBUGPC_RANGE 0x0020
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_ASIPDEBUGPC_MASK 0xffffffff
#define MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_ASIPDEBUGPC_RESET_VALUE 0x00000000
...
union MMIO_HUB_MEM_CVE_DPCG_CONTROL_REG_t CVE_DPCG_CONTROL_REG;
/*  offset 12'h230, width 32 */
union MMIO_HUB_MEM_CVE_PG_CONTROL_t CVE_PG_CONTROL;
/*  offset 12'h234, width 32 */
union MMIO_HUB_MEM_CVE_PG_DELAY_t CVE_PG_DELAY;
/*  offset 12'h238, width 32 */
union MMIO_HUB_MEM_CVE_PG_DFT_STAT_t CVE_PG_DFT_STAT;
/*  offset 12'h23C, width 32 */
union MMIO_HUB_MEM_PDEBUGPC_ENABLE_REG_t PDEBUGPC_ENABLE_REG;
/*  offset 12'h240, width 32 */
union MMIO_HUB_MEM_PDEBUGPC_TLC_REG_t PDEBUGPC_TLC_REG;
/*  offset 12'h244, width 32 */
union MMIO_HUB_MEM_PDEBUGPC_ASIP_REG_t PDEBUGPC_ASIP_REG;
...
#define CVE_MMIO_CVE_WATCHDOG_INIT                           123
#define CVE_MMIO_CVE_SECONDARY_WATCHDOG_INIT                 124
#define CVE_MMIO_CVE_CNC_WATCHDOG_INIT                       125
#define CVE_MMIO_CVE_ID                                      126
#define CVE_MMIO_HOST2TLC_INTERRUPT                          127
#define CVE_MMIO_HOST2ASIP_INTERRUPT                         128
#define CVE_MMIO_HOST2IVP_INTERRUPT                          129
#define CVE_MMIO_MMIO_NOTIFICATION                           130
...
#define CVE_MMIO_CVE_DPCG_CONTROL_REG                        140
#define CVE_MMIO_CVE_PG_CONTROL                              141
#define CVE_MMIO_CVE_PG_DELAY                                142
#define CVE_MMIO_CVE_PG_DFT_STAT                             143
#define CVE_MMIO_PDEBUGPC_ENABLE_REG                         144
#define CVE_MMIO_PDEBUGPC_TLC_REG                            145
#define CVE_MMIO_PDEBUGPC_ASIP_REG                           146
