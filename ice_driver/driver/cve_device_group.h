...
#define ice_dg_return_cached_mem(ntw) ({ \
	int ret = __ice_dg_return_cached_mem(ntw); \
	ret; \
})

#define ice_dg_find_matching_fw(ntw, md5, out_node) ({ \
	int ret = __ice_dg_find_matching_fw(ntw, md5, out_node); \
	ret; \
})
